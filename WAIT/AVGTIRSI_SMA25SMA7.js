...
class AVGTIRSI_SMA25SMA7 extends IStrategy_1.Strategy {
    getHeader() {
        this.csvFile.addRow(`${this.symbol}_${this.interval} BUY: avgTIRSI <= 10 && sma25 > sma7 && rsi < 32| SELL: avgTIRSI >= 90 && sma25 < sma7`);
...
exports.default = AVGTIRSI_SMA25SMA7;
