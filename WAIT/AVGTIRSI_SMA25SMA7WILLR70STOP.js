...
class AVGTIRSI_SMA25SMA7WILLR70STOP extends IStrategy_1.Strategy {
    getHeader() {
        this.csvFile.addRow(`${this.symbol}_${this.interval} BUY: avgTIRSI <= 10 && sma25 > sma7 && rsi < 32 && WILLR > -70| SELL: avgTIRSI >= 90 && sma25 < sma7 | STOPLOSS -0.05`);
...
exports.default = AVGTIRSI_SMA25SMA7WILLR70STOP;
