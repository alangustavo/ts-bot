...
const IStrategy_1 = require("../src/lib/IStrategy");
class AllStrategy extends IStrategy_1.Strategy {
    getHeader() {
        this.csvFile.addRow(`${this.symbol}_${this.interval} BUY: avgTIRSI < 10 | SELL: avgTIRSI > 85`);
