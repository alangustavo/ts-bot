...
class StochRSI0100 extends IStrategy_1.Strategy {
    getHeader() {
        this.csvFile.addRow(`${this.symbol}_${this.interval} BUY: StochRSI <=1 | SELL: StochRSI >=99`);
    ...
    getBuySignal(klines) {
        ...
        if (this.avgTIRSI < 10 && this.sma25 > this.sma7 && this.adosc < -70000) {
    ...
    getSellSignal(klines) {
        this.calculate(klines);
        if (this.avgTIRSI > 85 && this.sma25 < this.sma7 && this.adosc > 70000) {
