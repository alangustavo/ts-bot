...
export default class WILLR100_10_PRICE_SMA25 extends Strategy {
  ...
  public getHeader(): void {
    this.csvFile.addRow(
      `${this.symbol}_${this.interval} BUY: WILLR <= -99.99 && sma25 > sma7 && rso < 32| SELL: WILLR >= -51.99 && sma25 < sma7 && rsi >60 OR`
    );
    this.csvFile.addRow(
