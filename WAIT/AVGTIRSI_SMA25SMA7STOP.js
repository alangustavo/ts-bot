...
class AVGTIRSI_SMA25SMA7STOP extends IStrategy_1.Strategy {
    getHeader() {
        this.csvFile.addRow(`${this.symbol}_${this.interval} BUY: avgTIRSI <= 10 && sma25 > sma7 && rsi < 32| SELL: avgTIRSI >= 90 && sma25 < sma7 | STOPLOSS -0.05`);
    ...
    update(klines) {
        ...
        if (!this.inPosition) {
            ...
            if (signal === IStrategy_1.Signal.SELL ||
                signal === IStrategy_1.Signal.STOPLOSS ||
                signal === IStrategy_1.Signal.STOPGAIN) {
    ...
    getSellSignal(klines) {
        ...
        if (this.price / this.buyPrice - 1 > 0.035) {
            return IStrategy_1.Signal.STOPGAIN;
        }
...
exports.default = AVGTIRSI_SMA25SMA7STOP;
