...
export default class ESTUDO_RSICROSS extends Indicator {
    EMA_MIN3!: number;
    SMA_MIN27!: number;
    SMA_MAX27!: number;
    OBV!: number;
    ...
    calculate(k: Klines): Signal {
        ...
        this.RSI3 = t.rsi(closes, 3);
        this.RSI5 = t.rsi(closes, 5);
        ...
        // let buy = !this.OBV_OBV20 && !this.OBV_OBV10 && this.OBV20_OBV10;
        // buy = buy && this.RSI5 < this.RSI20 && this.RSI3 < this.RSI5;

        // buy = buy && !this.MIN3_MAX27 && !this.MIN3_MAX27_1002;
        // buy = buy && this.WILLR < -80;
        // buy = buy && this.STOCH_K < 20;
        // buy = buy && this.SRSI_K < 1;
        // buy = buy && this.RSI10 < 30;
        // let buy = !this.OBV_OBV20 && !this.OBV_OBV10 && this.OBV20_OBV10;
        // buy = buy && !this.MIN3_MAX27 && !this.MIN3_MAX27_1002;
        //buy = buy && this.RSI240 < 41;



        // let sell = this.OBV_OBV20 && this.OBV_OBV10 && !this.OBV20_OBV10;
        // sell = sell && this.RSI240 > 42;

        // sell = sell && this.RSI240 > 42;

        // let sell = this.OBV_OBV20 && this.OBV_OBV10 && !this.OBV20_OBV10;
        // sell = sell && !this.MIN3_MAX27_0975;
        // sell = sell && this.WILLR > -50;
        // sell = sell && this.RSI10 > 46;
        // sell = sell && this.RSI20 > 50;
        // sell = sell && this.RSI240 > 47;
        // sell = sell && this.STOCH_K > 50;
        // sell = sell && this.STOCH_D > 60;
        ...
        // let buy = this.SMA_MAX27 / this.EMA_MIN3 > 1.035 && this.OBV < this.EMA10OBBV && this.OBV < this.EMA20OBBV;
        // Lost 30% Jan/May
        let buy = this.RSI5 < this.RSI20 && this.RSI3 < this.RSI5;
        let sell = this.RSI240 > 42 && !this.MIN3_MAX27_0975;
