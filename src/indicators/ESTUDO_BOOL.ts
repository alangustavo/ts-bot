...
export default class ESTUDO_BOOL extends Indicator {
    MFI!: number;
    AVGSRSI!: number;
    SRSI_D!: number;
    SRSI_K!: number;
    ...
    calculate(k: Klines): Signal {
        ...
        if (
            price < this.DEMA99 &&
            this.DEMA99 > this.DEMA10 &&

            this.TEMA99 > this.TEMA10 &&
            // this.TEMA99 > this.TEMA20 &&
            // price > this.TEMA99 &&

            this.MFI < 70 &&
            price < this.EMA10CLOSES &&
            this.OBV < this.OBVEMA20 &&
            this.OBV < this.OBVEMA10 &&
            this.OBVEMA20 > this.OBVEMA10 &&
            this.AVGTIRSI < 90) {
            return Signal.BUY;
